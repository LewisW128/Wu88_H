...
import { MEMBER_BEST_BET, MEMBER_BEST_WIN, MEMBER_LEVEL_COLOR, MEMBER_LEVEL_LABEL, formatMoney } from "../lib/member";

const winListRows: RankSectionProps[] = [
  // The logged-in member's own row: Lv.8, her best round (lib/member.ts).
  { avatar: "/assets/win-list/avatar-0.png", name: "@Jessica", levelLabel: MEMBER_LEVEL_LABEL, levelBackground: MEMBER_LEVEL_COLOR, bet: formatMoney(MEMBER_BEST_BET), win: `+ ${formatMoney(MEMBER_BEST_WIN)}`, odds: `${(MEMBER_BEST_WIN / MEMBER_BEST_BET).toLocaleString("en-US", { minimumFractionDigits: 2 })}x`, thumb: "/assets/win-list/game-0.png" },
