...
//
// The hover Arrow_Special icon (node 66:66589's 2nd card) doesn't exist on
// the default cards at all -- it draws on via AnimatedArrowSpecial rather
// than fading in flat.
  ...
  return (
    ...
    >
      ...
      >
        ...
        <AnimatedArrowSpecial hovered={hovered} color="#23f3d5" className="pointer-events-none absolute right-[20.1px] top-[22px]" />
      </div>
    </div>
  );
}
